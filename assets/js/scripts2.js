  ...
  $(document).ready(function () {
    ...
    function render() {
      ...
      if ($(".striped-slides").length > 0) {
        ...
        striped_slides_interval = setInterval(function () {
          random_slide(cols);
        }, home_landing_s_slideshow_speed);
      ...
      if (
        $(".full-screen.flexslider.normal-nav, .full-screen.flexslider.no-nav")
          .length > 0
      ) {
      ...
      if (
        $(
          ".full-screen.flexslider.vertical-nav, .full-screen.flexslider.horizontal-nav"
        ).length > 0
      ) {
        ...
        $(
          ...
          before: function (slider) {
            $(".full-screen.flexslider .nav .bullets a.active").removeClass(
              "active"
            );
            $(
              ".full-screen.flexslider .nav .bullets a:eq(" +
                slider.animatingTo +
                ")"
            ).addClass("active");
          },
      ...
      if ($(".gallery-albums.masonry").length > 0) {
        ...
        masonry_init(
          ...
          ".gallery-albums .album.size-regular"
        );
      }
      ...
      if ($(".gallery-h.centered").length > 0) {
        ...
        var extra_amount_left =
            win_w / 2 - (first_img.width() / 2 + container_margin),
          extra_amount_right =
        ...
        $(".gallery-h.centered .gallery .container").mousewheel(function (
          event
        ) {
      ...
      if ($(".portfolio-striped").length > 0) {
        ...
        $(".portfolio-striped .project").width(
          (win_w - container_margin) / cols
        );
      ...
      if ($(".portfolio-single.style-1").length > 0) {
        if (win_w >= 768) {
          ...
          var total_width =
            $(".portfolio-single.style-1 .content > .info").width() +
            90 +
            $(".portfolio-single.style-1 .images").width();
    ...
    function resize() {
      ...
      if ($(".portfolio-single.style-1").length > 0) {
        ...
        $(".portfolio-single.style-1 .content .images a").each(function (
          index,
          el
        ) {
          var anchor = $(this),
    ...
    function gallery_scroll(direction) {
      ...
      if (
        ...
        if (direction == "right") {
          var scroll_amount =
            active_img.width() / 2 + next_img.width() / 2 + 30;
          $(".gallery-h .container").animate(
            { left: "-=" + scroll_amount },
            1000,
            "easeOutExpo",
            function () {
          ...
          var scroll_amount =
            active_img.width() / 2 + prev_img.width() / 2 + 30;
          $(".gallery-h .container").animate(
            { left: "+=" + scroll_amount },
            1000,
            "easeOutExpo",
    ...
    function random_slide(num) {
      ...
      if (home_slides_arr.length == 0 || home_slides_arr[0] != rand) {
        ...
        $(".striped-slides .cols .flexslider:eq(" + rand + ")").flexslider(
          "next"
        );
      } else {
        random_slide(num);
    ...
    if (
      $(".contact-1").length <= 0 &&
      $(".contact-2").length <= 0 &&
      $("body > .loader").length > 0
    ) {
      var bg_color =
          $("body > .loader").attr("data-background-color") || "#000000",
        text_color = $("body > .loader").attr("data-text-color") || "#ffffff";

      $("body > .loader").before(
        '<style id="cosy-custom-styler" type="text/css">.loader .circle{border: 2px solid ' +
          text_color +
          ";border-right-color: transparent;}</style>"
      );
      $("#cosy-custom-styler").append(
        ".loader p{color: " +
          text_color +
          ";}body > .loader{background-color: " +
          bg_color +
          ";}"
      );
    ...
    if ($(".gallery-h.normal").length > 0) {
      // On Image Hover
      $(".gallery-h.normal .gallery .container .img a").hover(
        function () {
      ...
      $(".gallery-h.normal .container .img a").magnificPopup({
        ...
        gallery: {
          ...
          arrowMarkup:
            '<button title="%title%" type="button" class="arrow-%dir%"></button>', // markup of an arrow button
      ...
      $(".gallery-h.normal .nav .prev").click(function (event) {
        ...
        $(".gallery-h.normal .gallery")
          .getNiceScroll(0)
          .doScrollLeftBy(scroll_amount);
      });
    ...
    if ($(".gallery-images").length > 0) {
      ...
      $(
        ".gallery-images .img .preview-2, .gallery-images .img .preview-3"
      ).magnificPopup({
        type: "image",
        closeOnContentClick: true,
        mainClass: "mfp-fade",
      ...
      $(
        ".gallery-images.style-title .img .overlay a:not('.video')"
      ).magnificPopup({
        type: "image",
        closeOnContentClick: true,
        mainClass: "mfp-fade",
    ...
    if ($(".portfolio-single.style-1").length > 0) {
      if (win_w >= 768) {
        ...
        $(".portfolio-single.style-1 .nav .next").click(function (event) {
          ...
          $(".portfolio-single.style-1 .inner-wrapper")
            .getNiceScroll(0)
            .doScrollLeftBy(-300);
        });
      ...
      // On Image Hover
      $(".portfolio-single.style-1 .content .images a").hover(
        function () {
          $(this).addClass("active");
          $(this).parent().parent().addClass("hovered");
        },
    ...
    $(
      ".contact-1 form input[type=button], .contact-2 form input[type=button]"
      ...
      if (
        ...
        current_form
          .find("input:not([type=button]), textarea")
    ...
    if ($(".contact-1 .map").length > 0) {
      var height =
          win_w < 768 ? $(".contact-1 .content-wrapper").height() + 60 : win_h,
        add =
          $(".contact-1 .map").attr("data-address") || "London, United Kindgom";
    ...
    if ($(".contact-1").length > 0) {
      if (win_w <= 1400) {
        ...
        var wrapper_height = $(".contact-1 .content-wrapper").height();
        $(".contact-1 .mCSB_inside > .mCSB_container").height(
          wrapper_height + 60
        );
      }
    }
    ...
    if ($(".contact-2 .map").length > 0) {
      var add =
        $(".contact-2 .map").attr("data-address") || "London, United Kindgom";
    ...
    if ($(".sidebar").length > 0) {
      $(".sidebar").imagesLoaded(function () {
        // On Image Hover
        $(".sidebar .widget.flickr li").hover(
          function () {
            $(this).addClass("active");
          },
          function () {
        ...
        // Widget hover out
        $(".sidebar .widget.flickr ul").hover(
          function () {
